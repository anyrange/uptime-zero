/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 12ff79b1db0a207522c83e246e7540b4)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MonitorActor";
	}
	interface Env {
		DB: D1Database;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
		MONITOR_ACTOR: DurableObjectNamespace<import("./src/api/index").MonitorActor>;
	}
}
