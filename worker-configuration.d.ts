/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: c1c71a68840777b2d9d86a79f05186fe)
// Runtime types generated with workerd@1.20260603.1 2026-05-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	SCHEDULER_ACTOR: DurableObjectNamespace<import("./src/api/index").SchedulerActor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/api/index");
		durableNamespaces: "MonitorActor" | "SchedulerActor";
	}
