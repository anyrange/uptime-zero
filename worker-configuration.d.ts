/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 0e25daf402aa522d8f360cffe7df27ab)
// Runtime types generated with workerd@1.20260831.1 2026-05-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_RATE_LIMIT: RateLimit;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	NOTIFICATION_ACTOR: DurableObjectNamespace<import("./src/server/index").NotificationActor>;
	SCHEDULER_ACTOR: DurableObjectNamespace<import("./src/server/index").SchedulerActor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "SchedulerActor" | "NotificationActor";
	}
