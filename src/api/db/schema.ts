...
export const monitors = sqliteTable("monitors", {
  ...
  sslExpiryWarnDays: integer("sslExpiryWarnDays"),
  sslExpiryFailDays: integer("sslExpiryFailDays"),
  ...
  lastCertValidTo: text("lastCertValidTo"),
  lastCertDaysRemaining: integer("lastCertDaysRemaining"),
  lastCertHostname: text("lastCertHostname"),
  lastSslStatus: text("lastSslStatus"),
...
export const heartbeats = sqliteTable(
  "heartbeats",
  {
    ...
    error: text("error"),
    certDaysRemaining: integer("certDaysRemaining"),
    createdAt: text("createdAt").notNull(),
